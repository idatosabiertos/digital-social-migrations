...
namespace NestaMigrations
{
    public class Startup
    {
        ...
        {
           services.AddDbContext<NestaContext>(options =>options.UseMySql(Configuration.GetConnectionString("DefaultConnection")));
            ...
            services.AddTransient<TranslateService, TranslateService>();
